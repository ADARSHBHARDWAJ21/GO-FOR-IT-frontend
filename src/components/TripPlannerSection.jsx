...
const TripPlannerSection = () => {
    ...
    const generateItinerary = async () => {
        ...
        try {
            ...
            const itinerary = await itineraryService.generateItinerary(aiTripDetails);
            
            console.log('AI itinerary generated successfully:', itinerary);
            ...
            itinerary.accommodation = mergedHotels;
            // Also expose top-level fields for the editor UI
            itinerary.flights = mergedFlights;
            itinerary.returnFlights = mergedReturnFlights;
            itinerary.trains = mergedTrains;
            itinerary.returnTrains = mergedReturnTrains;
            itinerary.hotels = mergedHotels;
    ...
    const generateItineraryAfterLogin = async () => {
        ...
        try {
            ...
            console.log('AI itinerary generated successfully after login:', itinerary);
